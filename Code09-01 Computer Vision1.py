...
def histoImage2():
    ...
    subCanvas = Canvas(subWindow, height = 256, width = 256)
    subPaper = PhotoImage(width = 256, height = 256)
    subCanvas.create_image((256//2, 256//2), image =subPaper, stat ='normal')
