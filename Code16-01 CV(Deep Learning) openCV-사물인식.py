...
def deepOpenCV() :
    ...
    net = cv2.dnn.readNetFromCaffe("C:\PySource\Project1\object-detection-deep-learning\MobileNetSSD_deploy.prototxt.txt", "C:\PySource\Project1\object-detection-deep-learning\MobileNetSSD_deploy.caffemodel")
    image = cvPhoto2
    (h, w) = image.shape[:2]
...
openCVMenu.add_command(label="영상 인식(딥러닝)", command=deep2OpenCV)
